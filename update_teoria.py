...
file_path = "F:/TRABAJO/APLICACIONES/EJERCICIOS Y ACTIVIDADES INTERACTIVAS/SAP/preparacion-bordes/script.js"
with open(file_path, "r", encoding="utf-8") as f:
    content = f.read()

replacements = [
    (r"teoria:\s*`<b>Definición:</b> Unión a tope con bordes rectos\. Es la preparación más económica al eliminar el biselado\.<br><b>Aplicación:</b> Limitada a espesores finos \(< 3-4 mm\)\. En espesores mayores, el arco no alcanza la raíz, causando una falta de penetración total\.`,",
     r"teoria: `<b>Normativa Técnica:</b> UNE-EN ISO 9692-1 (preparación de juntas para soldadura) / AWS D1.1 (código de soldadura estructural en acero).<br><br><b>Bordes rectos [Square groove weld]:</b> Unión a tope sin preparación especial en los bordes. Es la geometría más económica al eliminar el biselado mecanizado.<br><br><b>Aplicación crítica:</b> Limitada a chapas de espesor fino (generalmente < 3 mm). En espesores mayores, la falta de apertura [Root opening] impide que el arco alcance la zona inferior, causando una falta de penetración total [Incomplete joint penetration].`,"),
    
    (r"teoria:\s*`<b>Definición:</b> También llamada Bisel Simple\. Se utiliza cuando solo se puede acceder o mecanizar una de las piezas\.<br><b>Geometría:</b> Una pieza a 90º y la otra con chaflán inclinado\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Es el estándar universal para espesores medios \(5-15 mm\)\. Ofrece un acceso equilibrado del electrodo a la raíz\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Se usa para grandes espesores y acceso por ambos lados\. Reduce la distorsión angular y el consumo de metal\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Similar a la Y pero con fondo redondeado \(U\)\. Ofrece mejor acceso a la raíz en espesores elevados\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> La mejor opción para espesores muy gruesos\. Ahorra mucho hilo/electrodo frente a la V\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Equivalente a una X pero con una cara recta\. Se usa mucho en uniones en T de gran espesor\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Variante de la J simple aplicada en ambos lados de la chapa\. Se utiliza cuando solo se puede mecanizar una de las piezas, pero el gran espesor exige soldar por ambas caras para equilibrar tensiones\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Es la preparación más eficiente para espesores extremadamente gruesos \(>40mm\)\. Combina las ventajas de la U simple con la distribución de tensiones de la soldadura por ambas caras\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Unión donde una de las chapas se dobla 90° para formar una pestaña\. El propio material de la pestaña se funde para crear el cordón, a menudo sin necesidad de añadir hilo o electrodo externo\.`,",
    ...
    (r"teoria:\s*`<b>Definición:</b> Ambas chapas finas se doblan 90° hacia arriba y se juntan\. El arco funde ambas pestañas a la vez\. Es ideal para soldadura TIG autógena \(sin material de aporte\) en tanques de chapa fina\.`,",
...
print("Actualizadas las teorias de las preparaciones de bordes exitosamente.")
